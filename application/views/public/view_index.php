			...
			<div class="content-top-bottom">
				...
				<?php foreach($featured as $feature) : ?>
					<div class="col-md-4 men">
						<a href="<?php echo site_url('pages/show') . '/' . $feature['vehicle_id']; ?> " class="b-link-stripe b-animate-go  thickbox">
				...
				<div class="grid-in">
					{vehicles}
						<div class="col-md-3 grid-top simpleCart_shelfItem">
							<a href="<?php echo site_url('pages/show/{vehicle_id}'); ?>" class="b-link-stripe b-animate-go  thickbox">
