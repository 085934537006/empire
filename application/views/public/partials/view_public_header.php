...
<div class="header">
	<div class="header-top">
		...
		<div class="container">
			<div class="head-top">
				<div class="logo">
					<h1><a href="<?php echo site_url(); ?>">Empire</a></h1>
				</div>
		  <div class=" h_menu4">
				<ul class="memenu skyblue">
					<li><a class="color8" href="<?php echo site_url(); ?>">Home</a></li>	
					<li><a class="color4" href="<?php echo site_url('login'); ?>">Dashboard Login</a></li>
			  </ul> 
			</div>
